...
public class PeriscopeView extends RelativeLayout {
    ...
    public PeriscopeView(Context context) {
        super(context);
        init();
    }

    public PeriscopeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PeriscopeView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public PeriscopeView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init() {
        ...
        Drawable red = getResources().getDrawable(R.mipmap.ic_launcher_round);
        Drawable yellow = getResources().getDrawable(R.mipmap.ic_launcher_round);
        Drawable blue = getResources().getDrawable(R.mipmap.ic_launcher_round);
    ...
    private Animator getAnimator(View target) {
        ...
        scaleSet.playTogether(scaleX, scaleY, bezierValueAnimator);
        scaleSet.setTarget(target);

        finalSet.playTogether(scaleSet, set);
